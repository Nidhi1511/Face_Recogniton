from Detect_Face import detect_the_face
from Data_Train import train_data
from dataset_save import start_capture
...
class MainUI(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.title("CUSTOMER FACE RECOGNITION")
...
class StartPage(tk.Frame):
        ...
        def __init__(self, parent, controller):
            ...
            button1 = tk.Button(self, text="   Add User  ", fg="#ffffff", bg="#ff6347",command=lambda: self.controller.show_frame("PageOne"))
            button2 = tk.Button(self, text="   Check a User  ", fg="#ffffff", bg="#581845",command=lambda: self.controller.show_frame("PageTwo"))
            button3 = tk.Button(self, text="Go Back", fg="#263942", bg="#ffffff", command=self.on_closing)
        ...
        def on_closing(self):
            if messagebox.askokcancel("Go Back", "Are you sure?"):
                global names
...
class PageOne(tk.Frame):
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent)
        self.controller = controller
        tk.Label(self, text="Enter your name", fg="#263942", font='Helvetica 12 bold').grid(row=0, column=0, pady=10, padx=5)
        ...
        self.buttoncanc = tk.Button(self, text="Cancel", bg="#000000", fg="#ffffff", command=lambda: controller.show_frame("StartPage"))
...
class PageThree(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.trainbutton = tk.Button(self, text="Save The Model", fg="#ffffff", bg="#263942",command=self.trainmodel)
    ...
    def capimg(self):
        ...
        messagebox.showinfo("Message", "here it will Capture 300 pic of your Face.")
        x = start_capture(self.controller.active_name)
        self.controller.num_of_images = x
        self.numimglabel.config(text=str("Number of your image captured = "+str(x)))

    def trainmodel(self):
        if self.controller.num_of_images < 300:
            messagebox.showerror("ERROR", "No enough Data, Capture at least 300 images!")
            return
        train_data(self.controller.active_name)
        messagebox.showinfo("Message", "The image has been successfully saved!")
        self.controller.show_frame("PageFour")
...
class PageFour(tk.Frame):
    ...
    def openwebcam(self):
        detect_the_face(self.controller.active_name)
